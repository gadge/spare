...
var briefEntries = require('@spare/brief-entries');
...
const brief = (arr, {
  ...
  if (indexed) return briefEntries.brief(Object.entries(arr), {
    abstract,
    head,
    tail,
    preset,
...
const padEnds = (arr, {
  ...
  return Array.isArray(pad = (_pad = pad) !== null && _pad !== void 0 ? _pad : util.maxLen(arr, ansi)) ? arr.map((x, i) => util.rpad(x, pad[i], ansi, fill)) : arr.map(x => util.rpad(x, pad, ansi, fill));
};
/**
 *
 * @param {string[]} arr
...
const padStarts = (arr, {
  ...
  return Array.isArray(pad = (_pad2 = pad) !== null && _pad2 !== void 0 ? _pad2 : util.maxLen(arr, ansi)) ? arr.map((x, i) => util.lpad(x, pad[i], ansi, fill)) : arr.map(x => util.lpad(x, pad, ansi, fill));
};

exports.brief = brief;
exports.hBrief = hBrief;
exports.padEnds = padEnds;
exports.padStarts = padStarts;
exports.vBrief = vBrief;

import { bracket as bracket$1, parenth } from '@spare/bracket';
...
const toQueue = t => {
  ...
  let queue = [],
      l,
      d;
  if ((l = (_t = t = String(t)) === null || _t === void 0 ? void 0 : _t.length) && (d = deNaTab(t)) < l) queue.push(t.slice(d));
  return {
    indent: d,
    queue
  };
...
class Inka extends Callable {
  ...
  constructor(word, pretty = true) {
    ...
    [_classPrivateFieldLooseBase(this, _br)[_br], _classPrivateFieldLooseBase(this, _pa)[_pa]] = pretty ? [bracket, parenthesis] : [bracket$1, parenth];
    return new Proxy(this, {
      get(target, p, receiver) {
        ...
        return (...items) => {
          ...
          return queue.push((_items$map$join = items.map(String).join(COSP), _classPrivateFieldLooseBase(target, _pa)[_pa](_items$map$join))), receiver;
        };
      }
  ...
  br(...items) {
    return this.queue.push(items.map(parenth).join(CO)), this;
  }

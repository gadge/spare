...
// console.log($['Ridley Scott']('films').p('->')['Alien'](1979)['Blade Runner'](1982)['Thelma & Louise'](1991) + '')
...
test('xr test', () => {
  console.log($['Ridley Scott']('films').p('->')['Alien'](1979)['Blade Runner'](1982)['Thelma & Louise'](1991))
  console.log($['Stephen King']('books')['Carrie'](1974)['The Shining'](1977)['The Stand'](1978))
  console.log($['william shakespeare']('films').p('->')['tragedies']('Macbeth', 'King Lear', 'Hamlet', 'Romeo and Juliet'))
})

...
test('steno', () => {
  ...
  says['Object']('keys')['Plot camp   '](deco(Object.keys(x)))
  ...
  says['Reflect']('ownKeys')['Plot camp   '](deco(Reflect.ownKeys(x)))
  ...
  says['Object']('getOwnPropertyNames')['Plot camp   '](deco(Object.getOwnPropertyNames(x)))
  ...
  says['Object']('getOwnPropertyDescriptors')['Plot camp   '](deco(Object.getOwnPropertyDescriptors(x)))
  ...
  says['Object']('getOwnPropertySymbols')['Plot camp   '](deco(Object.getOwnPropertySymbols(x).map(t => t.description)))

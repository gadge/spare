...
const presetString = p => {
  return DecoConfig.build(p).assignConfigs(CONF_DECO_STRING).assignPresets(ATLAS, SUBTLE);
...
export { CONF_DECO_CROSTAB, CONF_DECO_ENTRIES, CONF_DECO_MATRIX, CONF_DECO_OBJECT, CONF_DECO_SAMPLES, CONF_DECO_STRING, CONF_DECO_TABLE, CONF_DECO_VECTOR, DecoConfig$1 as DecoConfig, HEADING_PRESET, LITERAL_PRESET$1 as LITERAL_PRESET, NUMERIC_PRESET$1 as NUMERIC_PRESET, presetCrostab, presetEntries, presetMatrix, presetObject, presetSamples, presetString, presetTable, presetVector };

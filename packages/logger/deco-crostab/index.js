 ...
 * @returns {string}
 */
export const Deco = (options = {}) => cosmetics.bind(presetCrostabOptions(options))
 ...
 * @returns {string}
 */
export const deco = (crostab, options = {}) => cosmetics.call(presetCrostabOptions(options), crostab)

...
export const candidates = {
  ...
  Shakes: 'Friends, Romans, countrymen, lend me your ears;I come to bury Caesar, not to praise him.The evil that men do lives after them;The good is oft interred with their bones.'.replace(/(?<=\w)([.,;:?!])(?=\w)/g, (_, p) => p + LF),
  ...
  LineVoid: 'start' + SP.repeat(82) + LF + 'cyberpunk',
  LineDash: 'start' + SP + 'a'.repeat(164) + LF + 'cyberpunk',
  Void: '',
  Space: ' ',
  Initial: 'UNESCO',
  Foo_Bar: 'FOO BAR',

...
test('node properties', () => {
  ...
  says['Object']('keys')['Node instance   '](deco(Object.keys(node)))
  ...
  says['Reflect']('ownKeys')['Node instance   '](deco(Reflect.ownKeys(node)))
  ...
  says['Object']('getOwnPropertyNames')['Node instance   '](deco(Object.getOwnPropertyNames(node)))
  ...
  says['Object']('getOwnPropertyDescriptors')['Node instance   '](deco(Object.getOwnPropertyDescriptors(node)))
  ...
  says['Object']('getOwnPropertySymbols')['Node instance   '](deco(Object.getOwnPropertySymbols(node).map(t => t.description)))

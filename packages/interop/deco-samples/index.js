...
import { parsePresm, Fold, tabs } from '@spare/node';
import { serialVector, serialMatrix } from '@spare/serial';
import { BRACE } from '@texting/enum-brackets';
import { COSP, LF, RTSP, COLF } from '@texting/enum-chars';
...
function decoSamples(samples, conf) {

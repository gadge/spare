...
const deVe = function (vector, lv) {
  ...
  if (config.presets) fluoVector.fluoVector.call(MUTATE_PIGMENT, vector, config.presets);
...
const deEn = function (entries, lv) {
  ...
  if (config.presets) fluoEntries.fluoEntries.call(MUTATE_PIGMENT, entries, config.presets);
